      ...
      <Container component="main" maxWidth="xs">
        ...
        >
          ...
          <Box component="form" ref={divRef} noValidate sx={{ mt: 1 }}>
            <TextField margin="normal" required fullWidth id="location" label="Location Address" name="address" />
            <TextField margin="normal" required fullWidth id="location" label="City" name="city" />
            <TextField margin="normal" required fullWidth id="location" label="Country" name="country" />
