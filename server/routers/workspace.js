...
router
  ...
  .delete(
    ...
    paramValidator,
    callbackErrorHandler(workspaceController.deleteWorkspacesFromArea)
  );
...
router
  ...
  .delete(
    restrictRoles([roles.administrator]),
    paramValidator,
    callbackErrorHandler(workspaceController.deleteWorkspacesFromLocation)
  );
...
router
  ...
  .get(
    ...
    paramValidator,
    callbackErrorHandler(workspaceController.getWorkspace)
  )
  .put(
    restrictRoles([roles.administrator]),
    paramValidator,
    bodyValidator,
    callbackErrorHandler(workspaceController.updateWorkspace)
  )
  .delete(
    restrictRoles([roles.administrator]),
    paramValidator,
    callbackErrorHandler(workspaceController.deleteWorkspace)
  );
...
router
  ...
  .post(
    ...
    callbackErrorHandler(workspaceController.createWorkspaces)
  );
